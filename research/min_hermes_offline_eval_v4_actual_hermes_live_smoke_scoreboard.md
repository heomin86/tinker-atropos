...
| actual_hermes_live_smoke | 0.6129 | 0.0000 | 0/5 | no |
...
## actual_hermes_live_smoke

### Env summary

| env | mean_total | pass_rate |
| --- | ---: | ---: |
| min_agentic_production_router | 0.6129 | 0.0000 |

### Weakest tasks

| task_id | title | total |
| --- | --- | ---: |
| production-router-landing-build | 웹사이트 제작 요청 라우팅 | 0.5120 |
| production-router-codex-in-hermes | 헤르메스 안 코덱스 씨엘아이 실행 요청 라우팅 | 0.5750 |
| production-router-obsidian-research | 연구 결과 옵시디언 기록 요청 라우팅 | 0.6200 |
