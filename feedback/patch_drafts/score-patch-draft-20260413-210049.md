...
suggested_changes:
  - file: "/Users/heomin/.hermes/hermes-agent/tinker-atropos/build_business_to_x_loop.py"
    category: "action"
    intent: "strengthen"
    phrase: "설명란과 이어지는 행동 문장"
    count: 2
    reason: "유튜브 행동 문장을 설명란 연결형으로 더 직접화"
      suggested_old: |
        item["본문"] += " 유튜브 설명란과 함께 읽히게 연결한다."
      suggested_new: |
  ...
  - file: "/Users/heomin/.hermes/hermes-agent/tinker-atropos/build_business_to_landing_loop.py"
    category: "headline"
    intent: "strengthen"
    phrase: "브랜드 중복 없는 Ailit headline"
    count: 2
    reason: "Ailit headline에서 브랜드 중복 제거와 상담 전환 직결 문구 강화"
      suggested_old: |
        suffix = strip_repeated_brand(suffix_after_marker(headline, "바로 이해하는 "), "Ailit")
        item["헤드라인"] = "Ailit 상담으로 이어지는 " + suffix
        item["CTA"] = "지금 진단 신청하기"
      suggested_new: |
        suffix = strip_repeated_brand(suffix_after_marker(headline, "부담 없이 신청으로 이어지는 "), "Ailit")
  ...
  - file: "/Users/heomin/.hermes/hermes-agent/tinker-atropos/build_business_to_landing_loop.py"
    ...
    count: 1
    reason: "채널 맥락이 헤드라인 첫머리에서 바로 보이게 보강"
      suggested_old: |
        item["헤드라인"] = "유튜브 시청자를 위한 " + strip_customer_intro(headline)
      suggested_new: |
        item["헤드라인"] = "유튜브 시청자가 바로 이해하는 " + suffix_after_marker(headline, "바로 이해하는 ")
      weight_old: |
        weights = {
                "headline_strength": 0.41,
                "cta_strength": 0.19,
  ...
  - file: "/Users/heomin/.hermes/hermes-agent/tinker-atropos/build_business_to_x_loop.py"
    ...
    count: 1
    reason: "유튜브 설명란 연결 문장을 실행 지시형으로 보강"
      suggested_old: |
        item["본문"] += " 유튜브 설명란과 함께 읽히게 연결한다."
      suggested_new: |
        item["본문"] += " 유튜브 설명란 첫 문장과 바로 이어지게 연결한다."
  ...
  - file: "/Users/heomin/.hermes/hermes-agent/tinker-atropos/build_business_to_retention_loop.py"
    category: "retention"
    intent: "penalize"
    phrase: "장황한 체크인 문구"
    count: 2
    reason: "체크인 문구 길이 감점을 더 빠르게 반영"
      suggested_old: |
  ...
  - file: "/Users/heomin/.hermes/hermes-agent/tinker-atropos/build_business_to_landing_loop.py"
    ...
    count: 1
    reason: "landing headline sales copy 강화"
      suggested_old: |
        HEADLINE_PATTERNS = [
  ...
  - file: "/Users/heomin/.hermes/hermes-agent/tinker-atropos/build_business_to_x_loop.py"
    ...
    phrase: "긴 설명형 본문"
    count: 1
    reason: "장문 본문 감점을 더 빠르게 주도록 보수 조정"
      suggested_old: |
  ...
  - file: "/Users/heomin/.hermes/hermes-agent/tinker-atropos/build_business_to_landing_loop.py"
    ...
    count: 1
    reason: "두 단계 CTA를 한 단계 행동형 CTA로 단순화"
      suggested_old: |
